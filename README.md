...
- Socket.IO rooms with server-authoritative move validation, reconnect support, invite links, bot fill, guest stats, live lobby discovery, table chat, activity counts, and replay export.
