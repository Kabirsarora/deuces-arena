...
- Socket.IO rooms with server-authoritative move validation, reconnect support, bot fill, guest stats, live lobby discovery, activity counts, and replay export.
